...
if ( function_exists('childtheme_override_head_scripts') )  {
    ...
    function cleanyetibasic_head_scripts() {
		...
		wp_enqueue_script( 'cleanyetibasic-foundation-js', get_template_directory_uri() . '/library/Foundation/js/foundation/foundation.js', array(), '5.5.0', true );
        wp_enqueue_script( 'cleanyetibasic-foundation-accordion-js', get_template_directory_uri() . '/library/Foundation/js/foundation/foundation.accordion.js', array(), '5.5.0', true );
        wp_enqueue_script( 'cleanyetibasic-foundation-tabs-js', get_template_directory_uri() . '/library/Foundation/js/foundation/foundation.tab.js', array(), '5.5.0', true );
        wp_enqueue_script( 'cleanyetibasic-foundation-topbar-js', get_template_directory_uri() . '/library/Foundation/js/foundation/foundation.topbar.js', array(), '5.5.0', true );
        foreach ( $option_parameters as $option_parameter ) {
            ...
            if ( 'javascript' == $section && isset( $cleanyetibasic_options[$name] ) && 1 == $cleanyetibasic_options[$name] ) {
                wp_enqueue_script( 'cleanyetibasic-foundation-' . $name . '-js', get_template_directory_uri() . '/library/Foundation/js/foundation/foundation.' . $name . '.js', array(), '5.5.0', true );
            }
        }
        wp_enqueue_script( 'cleanyetibasic-document-js', get_template_directory_uri() . '/library/Foundation/js/document.js', array () , '5.5.0', true );
	}
}
